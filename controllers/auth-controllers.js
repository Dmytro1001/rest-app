...
const { message } = require("../schemas/register-schemas");
...
const resendVerifiEmail = async (req, res) => {
...
const login = async (req, res) => {
  ...
  if (!user.verify) {
    throw HttpError(
      403,
      "You must verify your email to access your account. Please check your mailbox and complete the verification process to continue."
    );
  }
...
module.exports = {
  ...
  resendVerifiEmail: ctrlWrapper(resendVerifiEmail),
